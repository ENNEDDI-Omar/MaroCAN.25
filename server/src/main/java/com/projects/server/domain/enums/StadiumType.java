...
public enum StadiumType {
    ...
    STADE_AL_BARID("Stade annexe olympique Complexe sportif Prince Moulay Abdellah", "Rabat", 42000, 300.0),
    STADE_MOULAY_HASSAN("Le stade Moulay Hassan", "Rabat", 22000, 250.0),
